...
<div class="flex flex-col items-center text-center bg-white p-8 rounded-lg shadow-lg max-w-lg mx-auto mb-8">
  <!-- プロフィール画像 -->
  {#if profile.image}
      ...
      <ul class="space-y-2 mt-6">
        {#each profile.contacts as contact}
          <li class="flex items-center">
            ...
            <a class="text-blue-600 hover:text-blue-500" href={contact.url} target="_blank">
